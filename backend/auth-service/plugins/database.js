/**
 * DATABASE PLUGIN - AUTH SERVICE
 * 
 * WHAT IS A FASTIFY PLUGIN?
 * A plugin is a way to add functionality to the Fastify web server.
 * This plugin makes the database connection available to all routes in the auth service.
 * 
 * HOW IT WORKS:
...
export default fp(async (fastify, _opts) => {
  ...
  // This also creates tables if they don't exist
